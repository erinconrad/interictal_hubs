...
fprintf(['\nWithin both the original and revised implantation, the change '...
    ...
    'rate between the early and late stage of the original electrodes in the original implant ('...
    'Early M = %1.1f spikes/electrode/min (SD = %1.1f), Late M = %1.1f (%1.1f), t(%d) = %1.1f, %s), '...
    'of the original electrodes in the revised implant (Early M = %1.1f (SD = %1.1f), Late M = %1.1f (%1.1f), '...
    't(%d) = %1.1f, %s), or of the added electrodes in the revised implant ('...
...
fprintf(['\nThere was also no difference in the relative early-to-late spike rate change '...
    'between the original electrodes in the original '...
    'versus the revised implant (original relative change M = %1.1f (SD = %1.1f), '...
    'revised relative change M = %1.1f (SD = %1.1f), t(%d) = %1.1f, %s) or '...
    'between the original electrodes and the added electrodes in the revised '...
