...
[pre,post,pre_nans,post_nans] = get_surround_times(real_rate,change,surround);
...
for ib = 1:nb
    ...
    while 1
        ...
        if do_buffer
            [pre,post] = get_surround_times_buffer(real_rate,fchange,surround,buffer,pre_nans,post_nans);
        else
